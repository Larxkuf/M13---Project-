...
class ColeccionesScreen extends StatefulWidget {
  ...
  @override
  _ColeccionesScreenState createState() => _ColeccionesScreenState();
}
...
class _ColeccionesScreenState extends State<ColeccionesScreen> {
  ...
  Future<void> fetchColeccionData(int coleccionId) async {
    try {
      final response = await http.get(Uri.parse(
          "$baseUrl/auth/colecciones_screen.php?coleccion_id=$coleccionId"));
